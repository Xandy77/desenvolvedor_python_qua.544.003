...
from models import PessoaFisica, PessoaJuridica # Basta instanciar a PessoaFisica e PessoaJuridica
...
def main():
    ...
    usuario.endereco = input("Informe o endereço do usuário: ").strip()

    limpar()

    # informar os valores da empresa
    empresa.razão_social = input("Informe o nome juridico da empresa: ").strip()
